...
export default function LoginForm() {
  ...
  // 🟣 Remember Me: On mount, prefill email from localStorage if previously remembered
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 🟣 Remember Me: save or clear email (NEVER save password!)
      if (remember) {
  ...
  return (
    <div className="w-full max-w-[430px]">
            ...
            <input
              ...
              className={`h-[52px] w-full rounded-[10px] border bg-white pl-11 pr-12 text-[15px] text-[#111827] outline-none transition-all focus:ring-4 ${
                error
                  ...
                  : "border-[#e5e7eb] focus:ring-blue-100"
      ...
      <button
        ...
        className="h-[54px] w-full rounded-[10px] border border-[#e5e7eb] bg-white text-[15px] font-medium text-[#374151] transition-all hover:bg-[#f9fafb]"
      >
        Create Account
      </button>
