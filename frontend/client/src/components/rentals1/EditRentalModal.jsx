        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-4 sm:px-6 md:px-8 py-4 sm:py-6">
            ...
            <div className="relative" ref={customerDropdownRef}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="h-[44px] sm:h-[48px] w-full rounded-[10px] sm:rounded-[12px] border border-[#d1d5db] pl-9 pr-4 outline-none focus:border-[#8fb1f8] text-[14px]"
                />
              </div>
          ...
          <div className="mt-4 sm:mt-5">
            ...
            <select
              ...
              className="h-[44px] sm:h-[48px] w-full sm:max-w-[280px] rounded-[10px] sm:rounded-[12px] border border-[#d1d5db] px-3 sm:px-4 outline-none text-[14px]"
            >
          ...
          {formData.items.length === 0 ? (
            <p className="mt-4 text-[14px] sm:text-[16px] text-[#6b7280]">
              No items added yet
            </p>
          ) : (
